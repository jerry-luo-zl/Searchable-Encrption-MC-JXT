...
public class KeywordFilesGen2 {
	...
	public static void main(String[] args){
		...
		try {
			...
			ObjectInputStream in = new ObjectInputStream(new FileInputStream("FileKeywords2.dat"));
			FileKeywords[] fks2 = (FileKeywords[]) in.readObject();
			in.close();
			
			KeywordFiles[] kfs2 = new KeywordFilesGen2().Gen(fks2);
			
			ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("KeywordFiles2.dat"));
